...
function Header() {
  ...
  return (
    <div className='flex justify-between items-center'>
        <img src={logo} className='w-[180px] hover:font-bold cursor-pointer' onClick={()=>navigate('/')} />
        <ul className='hidden md:flex gap-4 md:gap-14'>
            <li className='hover:font-bold cursor-pointer' onClick={()=>navigate('/')}>Home</li>
            <li className='hover:font-bold cursor-pointer' onClick={()=>navigate('/AboutUs')}>About Us</li>
            <li className='hover:font-bold cursor-pointer' onClick={()=>navigate('/ContactUs')}>Contact Us</li>
        </ul>
